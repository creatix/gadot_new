...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (imageUrl.IndexOf("/") >= 0 Or imageUrl.IndexOf("\") >= 0) Then
            If imageUrl.IndexOf("cat\") = -1 And imageUrl.IndexOf("images\") = -1 And imageUrl.IndexOf("img\") = -1 Then
                Response.End()
            End If
        End If
        ...
        Response.AddFileDependency(imageUrl)
    ...
    Public Sub draw_sized_image(ByVal oImg As Bitmap, ByVal new_width As Integer, ByVal new_height As Integer, ByVal req_width As Integer, ByVal req_height As Integer)
        ...
        Try
            ...
            Dim oThumbNail As System.Drawing.Image = New Bitmap(req_width, req_height)
            ...
            Dim oRectangle As Rectangle = New Rectangle(tempx - 1, tempy - 1, new_width + 1, new_height + 1)
