...
Partial Class components_pagesfooter
    ...
    Sub loadpages()
        ...
        Dim _p As pList(Of pagesRow) = _pagesAdapter.GetList("fatherid=0 AND isnull(hide, 0) <> 1", "sort")
        _p.Reverse()
        rptPages.DataSource = _p
        rptPages.DataBind()
    ...
    Public Function GetLink() As String
        If Eval("pagesid") = 43 Then
            Return "#"
        End If
        Return pageLogic.GetLink("page", Eval("pagesid"), Eval("name"), Eval("page_link"))
    End Function
