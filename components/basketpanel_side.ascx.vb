...
Partial Class components_basketpanel_side
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Dim strurl As String = "https://www.auto365.co.il/" & IO.Path.GetFileName(myURL) ' & "?" & quary_str
    ...
    Sub loadBasket()
        ...
        If baskettable.DataSource.Count = 0 Then
            ...
            msglbl.Text = "לא נמצאו פריטים בסל הקניות"
            Exit Sub
        End If
